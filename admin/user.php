                        ...
                        <table 
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="form-group">
                                        <a href="?page_layout=edit_user&id=<?php echo $assoc['user_id']?>" class="btn btn-primary"><i class="glyphicon glyphicon-pencil"></i></a>
                                        <a href="?page_layout=delete_user&id=<?php echo $assoc['user_id']?>" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i></a>
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
