								...
								<table 
									...
									?>
										<tr>
											...
											<td class="form-group">
												<a href="?page_layout=edit_category&id=<?php echo $assoc['cat_id']; ?>" class="btn btn-primary"><i class="glyphicon glyphicon-pencil"></i></a>
												<a href="?page_layout=delete_category&id=<?php echo $assoc['cat_id']; ?>" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i></a>
											</td>
										</tr>
									<?php } ?>
									</tbody>
